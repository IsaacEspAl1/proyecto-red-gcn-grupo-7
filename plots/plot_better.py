...
df = pd.read_csv("resultados_entrenamiento_red_social_mejorada.csv")

# Create the plot with 2 y-axes
...
ax1.set_ylim(0, 1.05)  # accuracy values go from 0 to 1
...
plt.savefig("entrenamiento_grafico_precision_perdida_mejorado.png")
plt.show()
